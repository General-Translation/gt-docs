...
- Whenever an update to your site is translated into one language, it is automatically translated into all your site's existing languages. Similarly, whenever a user visits your site in a new language, translations are made in the background not just for the page they visit, but all previously translated pages. This means that for the vast majority of users and languages, displaying your site in another language is completely seamless.

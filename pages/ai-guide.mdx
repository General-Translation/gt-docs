...
export const { T, Numeric, Value, GTProvider, intl, Var, Num, Currency, Date } = createGT({
...
'use client'
import { useGT, Value } from 'gt-react'
import { useState } from 'react'
...
// ClientComponent.js
'use client'
import { useGT, Numeric } from 'gt-react'
import { useState } from 'react'
...
import { useLocale, useDefaultLanguage } from 'gt-react'

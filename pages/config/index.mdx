...
- **Type**: `string`
- **Description**: Specifies the API key for interacting with our cloud service. **It is best to set this in the environment as `GT_API_KEY` rather than in the config file.**

...
- **Type**: `string`
- **Description**: Specifies the name of the dictionary to use. This is useful for distinguishing between multiple projects or different sets of translations within the same project.

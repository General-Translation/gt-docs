...
For a step by step guide, check out the [CLI Tool guide](/docs/next2/guides/cli-tool).
...
Follow [this how-to guide](/docs/next2/guides/cli-tool) for more information on how to use the CLI tool.
 ...
 * Learn how to configure locales in our library's [i18n Configuration](/docs/next2/reference/i18n-configuration).
 ...
 * Follow our guide on [Locale Management](/docs/next2/guides/locale-list).
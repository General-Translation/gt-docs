...
- [`<Branch>`](/docs/next2/api/components/branch): Renders content based on a matching `branch` prop.
- [`<Plural>`](/docs/next2/api/components/plural): Renders content based on pluralization rules for a given number.
...
## Next Steps
 * Check out [`<Branch>`](/docs/next2/api/components/branch) and [`<Plural>`](/docs/next2/api/components/plural) in the API Reference for more details.
 ...
 * Explore [Variable Components](/docs/next2/reference/using-variable-components) in our reference guide.
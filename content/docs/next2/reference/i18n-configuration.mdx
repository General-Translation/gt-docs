...
The [`initGT()`](/docs/next2/api/config/initGT) function initializes General Translation (GT) settings for a Next.js application.
...
For a more detailed guide on selecting locales, refer to the [Locale Management Guide](/docs/next2/guides/locale-management).
...
## Next Steps
 * Read the API documentation for [`initGT()`](/docs/next2/api/config/initGT).
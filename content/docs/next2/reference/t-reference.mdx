...
This article will take an in depth dive into how to use the [`<T>` component](/docs/next2/api/components/t) in the `gt-next` library.
...
If you are looking for how to use [Variable Components](/docs/next2/reference/using-variable-components) or [Branching Components](/docs/next2/reference/using-branching-components), please refer to the respective articles.
...
These include [`<Var>`](/docs/next2/api/components/var), [`<Num>`](/docs/next2/api/components/num), [`<Currency>`](/docs/next2/api/components/currency) and [`<DateTime>`](/docs/next2/api/components/datetime) components.
...
Read more about it in the [Variable Components](/docs/next2/reference/using-variable-components) article.
...
These include [`<Plural>`](/docs/next2/api/components/plural) and [`<Branch>`](/docs/next2/api/components/branch) components.
...
Read more about it in the [Branching Components](/docs/next2/reference/using-branching-components) article.

### Translating Strings [#translating-strings]

Right now, the best way to translate a string is to use the [Dictionary Design Pattern](/docs/next2/reference/template-dictionaries/template-dictionaries).
...
Then you can call it using the [`useGT()`](/docs/next2/api/methods/client/useGT) hook or [`getGT()`](/docs/next2/api/methods/server/getGT) method for client and server-side components, respectively.
...
To circumvent this issue, use [Variable Components](/docs/next2/reference/using-variable-components#privacy) to handle all reformatting locally.
...
**TL;DR:** Variables will be translated, but please use [Variable Components](/docs/next2/reference/using-variable-components) or [Branching Components](/docs/next2/reference/using-branching-components) for this purpose.
...
To avoid this, we recommend using [Variable Components](/docs/next2/reference/using-variable-components) for displaying dynamic values and [Branching Components](/docs/next2/reference/using-branching-components) for conditional logic.
...
It is always best practice to wrap the conditional content in a [Branching Component](/docs/next2/reference/using-branching-components) to optimize the translation of content.
...
1. Use the [Branching Component](/docs/next2/reference/using-branching-components) to conditionally render content.
    If you want to conditionally display content based on a value, use the [`<Branch>`](/docs/next2/api/components/branch) component.
    This allows you to use pre-defined the content you want to be translated.

2. Use the [Variable Component](/docs/next2/reference/using-variable-components) to render dynamic content.
...
3. If you want to render a string, please use the [Dictionary Design Pattern](/docs/next2/reference/template-dictionaries/template-dictionaries).

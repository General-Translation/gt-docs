...
| Parameter                | Type                                                                 | Default                       | Description                                                                                                                                                                                                 |
|--------------------------|----------------------------------------------------------------------|-------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| `projectID`              | `string`                                                             |                               | Project ID, which can be included here or as an [environment variable](/docs/next/config#set-environment-variables).                                                                                         |
...
## Next Steps
 * Read more about [i18n configuration](/docs/next2/reference/i18n-configuration) in our reference guide.
 * Use the [CLI tool](/docs/next2/guides/cli-tool) to pre-translate your app for better performance.
...
Remember, the `<T>` component must be used inside a [`<GTProvider>`](/docs/next2/reference/t-design-patterns#gtprovider) to access the translation context.
 ...
 * Ensure the `<T>` component is wrapped in a [`<GTProvider>`](/docs/next2/reference/t-design-patterns#gtprovider) to access the translation context.

## Next Steps
 * Look into more advanced features like on-demand translation, variables, context, and handling plurals, refer to the [`<T>` Design Patterns](/docs/next2/reference/t-design-patterns) documentation.

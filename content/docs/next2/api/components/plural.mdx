...
It is like a specialized version of the [`<Branch>` component](/docs/next2/api/components/branch).
...
For a deeper dive into pluralization and branching, visit [Using Branching Components](/docs/next2/reference/using-branching-components).
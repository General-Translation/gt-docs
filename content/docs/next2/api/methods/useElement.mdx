...
The `useElement()` hook provides access to the `t()` translation function, which translates entries from your [template dictionary](/docs/next2/reference/template-dictionaries/template-dictionaries) into JSX elements.
...
See [here](/docs/next2/discussion/useElement) for a discussion on this design choice.
...
<Callout>
For translating strings, consider using [`tx()`](/docs/next2/api/methods/tx), [`useGT()`](/docs/next2/api/methods/client/useGT), or [`getGT()`](/docs/next2/api/methods/server/getGT) instead.
</Callout>
 ...
 * `useElement()` is "platform agnostic", meaning it can be used in both client-side and server-side components. Read more about it [here](/docs/next2/discussion/useElement).
 * For string-based translations, consider using [`tx()`](/docs/next2/api/methods/tx), [`useGT()`](/docs/next2/api/methods/client/useGT), [`getGT()`](/docs/next2/api/methods/server/getGT).

## Next Steps
 * See more examples and design patterns in the [Template Dictionary Design Pattern](/docs/next2/reference/template-dictionaries/template-dictionaries).
 ...
 * Combine `useElement()` with [Variable Components]((/docs/next2/reference/template-dictionaries/variable-components)) and [Branching Components]((/docs/next2/reference/template-dictionaries/branching-components)) for advanced translation scenarios.
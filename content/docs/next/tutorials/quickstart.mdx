...
description: Internationalize your Next.js App with General Translation
---
...
<Steps>
  <Step>
    ...
    change which language is displayed. * Change your language in
    [Chrome](https://support.google.com/chrome/answer/173424) * Change your
    language in
    [Firefox](https://support.mozilla.org/en-US/kb/use-firefox-another-language)
    * Change your language in
...
- Learn about how to use dictionaries with [`useGT()`](/docs/next/reference/template-dictionaries/template-dictionaries)

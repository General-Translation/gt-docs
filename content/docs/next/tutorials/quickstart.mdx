...
<Callout type="warn">
  **Experimental**
  ...
  We are currently adding support for automating string translations setup.
  Until then, please follow [this guide](/docs/next/tutorials/translating-strings) for translating strings.

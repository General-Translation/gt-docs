...
- Your app is required to use General Translation's services (API and CDN)
- In production, translations may take slightly longer to load (~100-200ms)

Local translations solve both of these problems. However, please note that there are also a few tradeoffs:
...
- **Cons:**
  ...
  - You will not be able to modify translations in production
    - With the GT CDN, you can modify translations in production without needing to re-publish your app. Changes go live within 1 minute.

...
<Callout>
  **Note:**
  If you are not using GT infrastructure, you will need to write a custom [`loadTranslations()`](/docs/next/api/config/load-translations) method to load translations from your preferred infrastructure.
</Callout>

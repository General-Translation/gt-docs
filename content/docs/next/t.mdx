 ...
 * Explore other localization techniques like [i18n Configuration](/docs/next/reference/i18n-configuration) and [i18n Routing](/docs/next/reference/i18n-routing).
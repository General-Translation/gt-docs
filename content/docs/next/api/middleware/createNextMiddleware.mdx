...
For more information on how to use this middleware, see the [i18n routing guide](/docs/next/guides/i18n-routing).
...
## Next steps
 * See [instructions](/docs/next/guides/i18n-routing) on how to add i18n routing to your Next.js application.
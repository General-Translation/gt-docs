...
supports translations in Spanish (`es`) and French (`fr`), and provides a description for context-aware translation.

The site will fallback to a supported language if the requested language is not English, French, or Spanish.

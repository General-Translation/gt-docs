...
When configured to use [local translations](/docs/next/tutorials/local-tx), the [`gtx-cli translate`](/docs/react-cli/translate) command, translations are saved to the `./public/_gt` directory.

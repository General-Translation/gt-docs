...
If you are looking to manually define your own translations, check out the [custom translations guide](/docs/next/reference/custom-translations)
 and the [`load-dictionary()`](/docs/next/api/config/load-dictionary) function.
...
When configured to use [local translations](/docs/next/tutorials/local-tx), the [`gtx-cli translate`](/docs/cli/translate) command,

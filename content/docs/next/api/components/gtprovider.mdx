...
- Optionally specify an `id` to limit the dictionary data sent to the client, optimizing performance for large dictionaries.

You can read more about its application [here](/docs/next/reference/t-reference#gtprovider).

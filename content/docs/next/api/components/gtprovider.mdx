...
- The `<GTProvider>` component is used for both [inline `<T>`](/docs/next/reference/t-reference) and [dictionary design patterns](/docs/next/reference/dictionaries/dictionaries).

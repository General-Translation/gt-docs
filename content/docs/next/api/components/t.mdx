...
Its contents will be translated into a target language.
...
Remember, the `<T>` component must be used inside a [`<GTProvider>`](/docs/next/reference/t-reference#gtprovider) to access the translation context.

...
The `getGT()` function retrieves the server-side equivalent of the `t()` translation function, enabling translations from the [template dictionary](/docs/next/reference/dictionaries/dictionaries) during server-side rendering.
 ...
 * Supports dynamic behavior and variable insertion with [Branching](/docs/next/reference/dictionaries/branching-components) and [Variable Components]((/docs/next/reference/dictionaries/variable-components)) respectively.

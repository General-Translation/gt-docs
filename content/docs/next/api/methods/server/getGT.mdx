 ...
 * Enhance server-side locale routing with [i18n Routing](/docs/next/reference/i18n-routing) and locale management with [i18n Configuration](/docs/next/reference/i18n-configuration).
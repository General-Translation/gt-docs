...
The `useElement()` hook provides access to the `t()` translation function, which translates entries from your [template dictionary](/docs/next/reference/dictionaries/dictionaries) into JSX elements.
...
<Callout>
    ...
    To read more about the Template Dictionary Design Pattern, see [this article](/docs/next/reference/dictionaries/dictionaries).
</Callout>
...
<Callout>
For translating strings, consider using [`tx()`](/docs/next/api/methods/tx), [`useGT()`](/docs/next/api/dictionary/useGT), or [`getGT()`](/docs/next/api/dictionary/getGT) instead.
</Callout>
...
Both [Variable Components](/docs/next/reference/dictionaries/variable-components)
and [Branching Components](/docs/next/reference/dictionaries/branching-components)
 ...
 * For string-based translations, consider using [`tx()`](/docs/next/api/methods/tx), [`useGT()`](/docs/next/api/dictionary/useGT), [`getGT()`](/docs/next/api/dictionary/getGT).

## Next Steps
 * See more examples and design patterns in the [Template Dictionary Design Pattern](/docs/next/reference/dictionaries/dictionaries).
 * Explore the [Template Dictionary Design Pattern](/docs/next/reference/dictionaries/dictionaries) for creating flexible and dynamic dictionaries.

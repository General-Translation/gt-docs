...
<Callout>
For translating strings, consider using [`tx()`](/docs/next/api/strings/tx), [`useGT()`](/docs/next/api/dictionary/useGT), or [`getGT()`](/docs/next/api/dictionary/getGT) instead.
</Callout>
 ...
 * For string-based translations, consider using [`tx()`](/docs/next/api/strings/tx), [`useGT()`](/docs/next/api/dictionary/useGT), [`getGT()`](/docs/next/api/dictionary/getGT).

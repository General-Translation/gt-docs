...
Variable components in dictionaries require you to pass dynamic data when fetching the translation.
 ...
 * Combine Variable Components with [Branching Components](/docs/next/reference/dictionaries/branching-components) for more advanced logic.

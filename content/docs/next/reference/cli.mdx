...
For a step by step guide, check out the [CLI Tool guide](/docs/next/guides/cli-tool).
...
Follow [this how-to guide](/docs/next/guides/cli-tool) for more information on how to use the CLI tool.
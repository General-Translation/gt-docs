...
The [`initGT()`](/docs/next/api/config/withGTConfig) function initializes General Translation (GT) settings for a Next.js application.
...
## Next Steps
 * Read the API documentation for [`initGT()`](/docs/next/api/config/withGTConfig).
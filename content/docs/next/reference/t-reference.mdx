...
For more information, you can refer to [our guide on translating strings](/docs/next/tutorials/translating-strings).
 ...
 * Learn about [translating strings](/docs/next/tutorials/translating-strings) in your application.

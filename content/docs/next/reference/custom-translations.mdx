---
title: Custom Translations Files
description: Using your own translation files
---

## Overview

This guide will walk you through internationalizing your existing Next.js app with user-defined translations.
All translations are stored in your project's repository and managed by you, similar to a traditional i18n setup.
...
Translations are then referenced in your app with the [`useDict()`](/docs/next/api/dictionary/useGT) hook:
...
<Callout>
  **Note:** Because these translations are managed by you, you will need to update them manually as your app evolves.
  ...
  Consider using [`loadTranslations()`](/docs/next/api/config/load-translations) if you are interested in automating this process.
</Callout>
...
<Callout>
  **Tip:** For more information on dictionary syntax, see the [dictionary reference](/docs/next/reference/dictionary-reference).
</Callout>
 ...
 * Try using [`loadTranslations()`](/docs/next/api/config/load-translations) to automate the translation process.
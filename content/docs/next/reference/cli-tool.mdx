...
This is a guide on how to use the [General Translation CLI tool](/docs/next/reference/cli) to deploy your site to production.
...
If you haven't, please follow the [Next Quick Start Guide](/docs/next/tutorials/quickstart) before proceeding.
...
```bash copy
npx gt-next-cli translate --new fr es ja
```
...
## Next steps
 * Learn more about the [CLI tool](/docs/next/reference/cli) and [pre-translation](/docs/next/reference/cli#pre-translation).

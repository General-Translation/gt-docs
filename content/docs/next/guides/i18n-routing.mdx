...
You should include `defaultLocale` and `locales` in both `middleware.js` and [`next.config.js`](/docs/next/guides/locale-management#include-locales).
...
For more in depth how to guide see [Locale Management](/docs/next/guides/locale-management).
...
## Next Steps
 * Read more about [Locale Management](/docs/next/guides/locale-management).
 * Learn how to [Translate Your Application](/docs/next/guides/translate-your-application).
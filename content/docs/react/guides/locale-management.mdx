...
The simplest way to manage locales is specifying them through the [`npx gt-react-cli translate`](/docs/react-cli/translate) command by using the `--locales` flag.

...
This function enables you to retrieve the translated version of an entry from your [template dictionary](/docs/next/reference/dictionaries/dictionaries).
...
The `useGT` hook retrieves the `t` function, which can translate any key from your [template dictionary](/docs/next/reference/dictionaries/dictionaries).

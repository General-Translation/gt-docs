...
See [`<GTProvider>`](/docs/react/api/config/gtprovider#supported-locales) for information on configuring supported locales.
...
## Next Steps
 * Learn how to manage and specify supported locales in your application with [locale management](/docs/react/guides/locale-management).

...
You can specify a `loadTranslation()` function to get translations from a different source, such as:
...
Follow [this guide](/docs/react/tutorials/local-tx) to set up local translations in your React app.
...
When configured to use [local translations](/docs/react/tutorials/local-tx), the [`gt-react-cli translate`](/docs/react-cli/translate) command, translations are saved to the `./src/_gt` directory.
 ...
 * Its most common use case is for adding [local translations](/docs/react/tutorials/local-tx)

## Next steps
 * Learn about why you might want to use [local translations](/docs/react/tutorials/local-tx)
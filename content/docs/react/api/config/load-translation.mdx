...
When configured to use [local translations](/docs/react/tutorials/local-tx), the [`gtx-cli translate`](/docs/cli/translate) command, translations are saved to the `./src/_gt` directory.

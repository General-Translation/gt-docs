...
It also directly integrates with the [`gtx-cli translate` command](/docs/react-cli/translate), so you don't have to specify things like locales manually as a parameter.

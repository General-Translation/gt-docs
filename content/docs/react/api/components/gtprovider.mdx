...
- The `<GTProvider>` component is used for both [inline `<T>`](/docs/react/reference/t-reference) and [dictionary design patterns](/docs/react/reference/dictionaries/dictionaries).

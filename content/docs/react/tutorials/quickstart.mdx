...
<Steps>
    ...
    <Step>
        ...
        <Tabs items={["Vite", "Gatsby", "create-react-app", "Other"]}>
            <Tab value="Vite">
            ```bash copy
...
<Accordions>
  ...
  <Accordion title="Why are some things translating and others not?">
    **JSX Translation**
    ...
    Until then, if you are rendering a string, try using the [`useGT()`](/docs/react/api/dictoinary/useGT) for string translation.
  </Accordion>
</Accordions>

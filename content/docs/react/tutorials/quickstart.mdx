...
<Steps>
    ...
    <Step>
        Add the Project ID and API Key to your environment variables. Depending on your React framework, the environment variables may look slightly different.
        <Tabs items={["Vite", "Gatsby", "create-react-app"]}>
            <Tab value="Vite">
            ```bash copy
    ...
    <Step>
    **(Optional)** 
    The following steps are only required for shipping your app to production.

        Navigate to the [Dashboard](https://generaltranslation.com/dashboard).
        * Navigate to the **API Keys** page in the sidebar.
        * Click **Create API Key** then copy the API key to your clipboard.
    </Step>
    <Step>
        Add your API key and Project ID to your environment variables.
        ```bash copy
...
<Callout>
    **Example**
    ...
    Each component will be given a unique `id` prop. This prop is not required!

...
<Tabs items={["npm", "yarn", "bun", "pnpm"]}>
  ...
  <Tab value="yarn">
  ```bash 
  yarn add gt-react gt-react-cli
  ```
  </Tab>
  <Tab value="bun">
  ```bash 
  bun add gt-react gt-react-cli
  ```
  </Tab>
  <Tab value="pnpm">
  ```bash 
  pnpm add gt-react gt-react-cli
  ```
  </Tab>
</Tabs>
...
See the [CLI tool documentation](/docs/reference/cli#setup) for more information.
...
For example, if your project uses [Vite](https://vitejs.dev), you can add the API key as follows:
...
For more information, see the [CLI tool documentation](/docs/usage/cli-tool#usage).

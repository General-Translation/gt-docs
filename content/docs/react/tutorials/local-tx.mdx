...
Let's say that you have added the [`gtx-cli translate`](/docs/react-cli/translate) command to your CD process.
...
<Steps>
  ...
  <Step>
    ...
    ```bash
    npx gtx-cli translate --no-publish --translations-dir ./src/_gt
    ```

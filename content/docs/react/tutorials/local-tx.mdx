...
See the `loadTranslation` function in the [API Reference](/docs/react/api/config/load-translation) for more information on writing a custom translation loader.

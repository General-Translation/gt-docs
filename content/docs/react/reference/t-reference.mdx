...
```
For more information, you can refer to [our guide on translating strings](/docs/react/tutorials/translating-strings).
...
For more information on the command, please refer to the [CLI Tool](/docs/react-cli/translate) reference guide.
...
While in development, any content in a `<T>` component will be translated on-demand.
We do this for convenience during the development process.
But, when deploying to production, all translations occur at build time.
 ...
 * Learn about [translating strings](/docs/react/tutorials/translating-strings) in your application.

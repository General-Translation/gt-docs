...
This is a guide on how to use the [General Translation CLI tool](/docs/react/reference/cli) to deploy your site to production.
...
Read more about the CLI tool [here](/docs/react/reference/cli).

This guide assumes that you have already integrated `gt-react` into your project.
If you haven't, please follow the [React Quick Start Guide](/docs/react/tutorials/quickstart) before proceeding.
...
<Steps>
    ...
    <Step>
        ...
        <Tabs items={["npm", "yarn", "bun", "pnpm"]}>
          ...
          <Tab value="bun">
          ```bash 
          bun add gt-react-cli --dev
          ```
          </Tab>
          <Tab value="pnpm">
          ```bash 
          pnpm add gt-react-cli --save-dev
          ```
          </Tab>
        </Tabs>
    </Step>
...
```bash copy
npx gt-react-cli translate --new fr es ja
```
...
To translate your app in advance, rerun with the --new flag. For example: `npx gt-cli translate --new fr`
```
...
```bash copy
npx gt-react-cli translate --dry-run
```
...
## Next steps
 * Learn more about the [CLI tool](/docs/react/reference/cli) and [pre-translation](/docs/react/reference/cli#pre-translation).

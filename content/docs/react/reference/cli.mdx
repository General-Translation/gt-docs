...
Read more about `gt-react-cli` [here](/docs/react-cli/introduction).
 ...
 * [The `setup` command ](/docs/react-cli/setup) is used to automatically integrate the General Translation library into your project.
   It will scan through your project and wrap any JSX content with a `<T>` component.
 * [The `translate` command](/docs/react-cli/translate) is meant to be added to the CD pipeline.

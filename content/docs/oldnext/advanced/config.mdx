...
An API key (`GT_API_KEY`) is a 36-character string beginning `gtx-` which is used to authenticate your app with our cloud translation service. Create one on the [API Keys](https://generaltranslation.com/dashboard/redirect/api-keys) page.

...
See the [load-translation docs](/docs/next/api/config/load-translation#fetching-translations-from-your-bundle) for more details.
...
See our docs on that: [here](/docs/next/api/config/load-translation#fetching-translations-from-your-bundle).

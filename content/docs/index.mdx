...
Welcome to the docs for [General Translation, Inc.](https://www.generaltranslation.com) (GT)! 

{/* We publish open-source internationalization libraries for [React](https://react.dev) and [Next.js](https://nextjs.org) apps. 
Plus, we provide a [platform](https://generaltranslation.com/dashboard) for automating your entire internationalization (i18n) stack. */}
...
General Translation is an entire i18n stack, including developer SDKs, AI translation services, and a complete infrastructure package for multilingual apps.

General Translation manages everything for you, so you can focus on shipping features and new content.

We currently support the following frameworks:
- [Next.js](/docs/next/tutorials/quickstart) (Both the [App Router](/docs/next/tutorials/quickstart) and [Pages Router](/docs/react/tutorials/quickstart))
- [React](/docs/react/tutorials/quickstart)
- [Vite](/docs/react/tutorials/quickstart)
- [Gatsby](/docs/react/tutorials/quickstart)
...
- GT libraries also support the same features as existing libraries like `next-intl` and `next-i18next`.
...
- All GT libraries have simple interfaces and are easy to use.
...
## Getting started
Follow our quickstart guides. Each guide should take no more than 10 minutes to complete:
<Cards>
  <Card
    title="React"
...
<Callout>
  We recommend using the [React CLI tool](/docs/react/reference/cli) or the [Next.js CLI tool](/docs/next/reference/cli) to create

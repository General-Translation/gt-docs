...
<Tabs items={['Next.js', 'React']}>
    <Tab value="Next.js">
    Follow the [Quickstart](/docs/next/quickstart) guide to ship your first translations.
...
Most projects should use the [CLI tool](/docs/next/cli) to create translations in advance, rather than relying on on-demand translations.

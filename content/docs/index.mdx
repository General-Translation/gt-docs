...
export default async function MyServerComponent() {
  ...
  return (
    <T>
      Hello, <Var>{name}</Var>  // [!code highlight]
    </T>
  );
}
```
...
export default function Page() {
  return (
    <T>
      <p>Hello, World!</p>  {/* translates <p>Hello, World!</p> */} // [!code highlight]
    </T>
  )
}
```
...
<Tabs items={['.json', '.js']}>
  ...
  {
    "greeting": "Hello, World!" // [!code highlight]
  }
  ```
  </Tab>
  <Tab value=".js">
  ```jsx title="dictionary.js" copy
  const dictionary = {
    greeting: "Hello, World!" // [!code highlight]
  }

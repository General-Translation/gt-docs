...
Then the newly translated content will be distributed to the CDN which will be ready for users to request when needed.

## When translate in advance?
...
```bash copy
npx translate --locales en fr es
```

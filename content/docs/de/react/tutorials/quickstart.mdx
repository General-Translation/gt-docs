...
Dieser Leitfaden beschreibt, wie ein bestehendes [React](https://react.dev) Projekt internationalisiert wird.
...
<Callout type="info">
  **Tipp:**
  ...
  Dieser scannt Ihren Code für übersetzbare JSX und fügt die [`<T>`](/docs/react/api/components/t)-Tags für Sie ein.
...
<Steps>
    ...
    <Step>
        ...
        <Tabs items={["Vite", "Gatsby", "RedwoodJS", "create-react-app", "Other"]}>
            ...
            aber bitte lassen Sie es uns wissen, wenn Ihr Framework nicht aufgeführt ist, indem Sie ein Problem in unserem [GitHub-Repository](https://github.com/General-Translation/gt-libraries/issues/new) erstellen.
            </Tab>
        </Tabs>
    </Step>
</Steps>
<Callout type="warn">
    **Schützen Sie Ihre API-Schlüssel!**
    ...
    React-Umgebungsvariablen werden oft zur Build-Zeit in Ihre Anwendung gebündelt und sind im clientseitigen Code öffentlich sichtbar.
...
<Steps>
  <Step>
    Füge die Komponente [`<LocaleSelector>`](/docs/react/api/components/localeSelector) zu deiner App hinzu.
...
<Accordions>
  <Accordion title="Die Sprache meiner App ändert sich nicht, obwohl ich die Sprache meines Browsers geändert habe.">
    ...
    * [Edge](https://support.microsoft.com/en-us/microsoft-edge/delete-cookies-in-microsoft-edge-63947406-40ac-c3b8-57b9-2a946a29ae09)
    ...
    Wenn dies nicht funktioniert, stelle sicher, dass die Liste der Sprachen in deinem [`<GTProvider>`](/docs/react/api/components/gtprovider) auf dem neuesten Stand ist.
  </Accordion>
  <Accordion title="Warum dauert es lange, bis neue Sprachen geladen werden?">
    **On-Demand-Übersetzung**

    Du wirst vielleicht bemerken, dass beim Laden von Sprachen in der Entwicklung die Übersetzungen ein paar Sekunden benötigen, um angezeigt zu werden.
  ...
  <Accordion title="Warum werden einige Dinge übersetzt und andere nicht?">
    **JSX-Übersetzung**
    ...
    Bis dahin, wenn du einen String renderst, folge bitte [diesem Leitfaden](/docs/react/reference/translating-strings) für die Übersetzung von Strings.
  </Accordion>
</Accordions>

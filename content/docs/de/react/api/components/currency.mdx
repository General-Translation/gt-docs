...
Die Zahl wird basierend auf dem aktuellen Gebietsschema und allen übergebenen optionalen Parametern formatiert.
...
| `name`      | Optionaler Name für das Währungsfeld, das für Metadatenzwecke verwendet wird.                                                                                      |

---
title: InlineÜbersetzungsOptionen
description: API-Referenz für den Typ InlineÜbersetzungsOptionen
---
...
Er wird mit [`useGT()`](/docs/react/api/strings/useGT) verwendet, um Variablen an Inline-String-Übersetzungen zu übergeben.

<Callout>
  **Buildtime-Übersetzung:**
  `useGT()`-Übersetzungen erfolgen zur Buildzeit; jedoch werden Variablen niemals übersetzt.
...
## Nächste Schritte
 * Siehe [`useGT()`](/docs/react/api/strings/useGT) für weitere Informationen über Inline-String-Übersetzungen.

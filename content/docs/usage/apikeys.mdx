 ...
 * The [`gtx-cli`](/docs/cli) tool when translations are generated during the deployment process. Check out [this guide](/docs/react/tutorials/quickdeploy) for more information.

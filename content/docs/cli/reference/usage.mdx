---
title: Usage Guide
description: Usage guide for the General Translation CLI tool.
---

## Overview

This guide will walk you through the process of using the General Translation CLI tool to translate your project.
...
### Translating language files (3rd party i18n libraries)

The CLI tool allows you to translate language files for 3rd party i18n libraries.

Most 3rd party i18n libraries rely on JSON files to store translation data.
...
## Next steps
 * See the [CLI API reference](/docs/cli/introduction) for more information.

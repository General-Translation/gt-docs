...
"files": {
  "json": {
    "include": ["path/to/your/[locale].json"],
  }
}
```
...
With this configuration, the CLI will search for the file at `path/to/your/en.json` and save the translated files to `path/to/your/fr.json` and `path/to/your/es.json`.

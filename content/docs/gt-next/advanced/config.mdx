...
- **Type**: `string`
- **Default**: `"default"`
- **Description**: The user-defined name of the dictionary used for translation. Multiple dictionaries can exist within the same project if they each have different a `dictionaryName`. Only available to users on paid plans.

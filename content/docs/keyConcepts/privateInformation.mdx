...
### Dynamic Content
[Dynamic Content](/docs/oldnext/keyConcepts/dynamicContent) is generally any content that can change based on the user, context, environment, etc.
Private information is a subset of dynamic content that specifically refers to information that should remain private.
Read more about dynamic content [here](/docs/oldnext/keyConcepts/dynamicContent).
{/* TODO: add a chart diagram */}

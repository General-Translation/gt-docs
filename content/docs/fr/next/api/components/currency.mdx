...
Lisez-en plus sur les [Intl.NumberFormatOptions](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Intl/NumberFormat) pour plus d'options.
 ...
 * Le contenu du composant `<Currency>` ne sera pas envoyé à l'API pour traduction.
   Tout le reformatage est effectué localement à l'aide de la bibliothèque [`Intl.NumberFormat`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Intl/NumberFormat).

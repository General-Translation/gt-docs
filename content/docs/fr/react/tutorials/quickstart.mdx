...
<Callout type="info">
  **Astuce :**
  ...
  Cela analysera votre code pour le JSX traduisible et insérera les balises [`<T>`](/docs/react/api/components/t) pour vous.
...
<Accordions>
  ...
  <Accordion title="Pourquoi les nouvelles langues mettent-elles du temps à se charger ?">
    **Traduction à la demande**

    Vous pouvez remarquer lors du chargement des langues en développement, que les traductions prennent quelques secondes à s'afficher.
  ...
  <Accordion title="Pourquoi certaines choses se traduisent-elles et d'autres non ?">
    **Traduction JSX**
    ...
    D'ici là, si vous affichez une chaîne, veuillez suivre [ce guide](/docs/react/reference/translating-strings) pour traduire les chaînes.
  </Accordion>
</Accordions>
...
## Prochaines étapes
 * Consultez notre [référence API React](/docs/react/api/components/t) pour des informations détaillées sur le composant `<T>` et d'autres composants disponibles.

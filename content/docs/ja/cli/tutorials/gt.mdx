---
title: GTライブラリ
description: GTライブラリであなたのプロジェクトを自動的に翻訳
---

## 概要

このチュートリアルでは、[`gt-next`](/docs/next)または[`gt-react`](/docs/react)を使用する際に、プロジェクトの翻訳ファイルを自動的に管理する方法を紹介します。
 ...
 * 開発中にライブ翻訳（ホットリロードのようなもの）を確認したい場合は、[`<T>` コンポーネント](/docs/usage/t)をチェックしてください。
---
title: i18next
description: i18nextプロジェクトを自動的に翻訳する（5分未満）
---

## 概要

このチュートリアルでは、[`i18next`](https://i18next.com/)プロジェクトの翻訳ファイルを自動的に管理する方法を紹介します。
...
ビルドまたはCIプロセスに`gtx-cli translate`コマンドをビルドコマンドの前に追加して、プロジェクトに自動的に翻訳を追加します。

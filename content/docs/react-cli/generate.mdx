...
```bash
npx gt-react-cli generate
```

## Overview

The `gt-react-cli generate` command generates a source file for your project for your default locale.

This source file has the same data structure as your project's translations, and should be used as a template for you
to create your own translation files.

To create your own translation files, you can duplicate the source template and translate the content strings.

Then, you can rename the translation files to the corresponding locale and use [local translations](/docs/react/tutorials/local-tx) to serve the translations to your users.

...
As a rule of thumb, the CLI will wrap the [`<T>`](/docs/react/api/components/t) component around any static, meaningful content.
It will also wrap a [`<Var>`](/docs/react/api/components/var) component around any dynamic subcontent contained within a `<T>` component.
...
<Accordions>
  <Accordion title="Why can't <T> components wrap dynamic content?">
    ...
    If you would like to translate content that changes at runtime, you should use the [`<Tx>`](/docs/react/api/components/t) component instead.
  </Accordion>
...
The CLI will automatically wrap expressions `{...}` in [`<Var>`](/docs/react/api/components/var) components.
...
<Callout type="warn">
  ...
  If you would like to translate dynamic content, you should use the [`<Tx>`](/docs/react/api/components/t) component instead.
</Callout>
...
The CLI will wrap template literals containing quasis (`${}`) in a [`<Var>`](/docs/react/api/components/var) component, since they can be dynamic.
```jsx
...
will be wrapped in a [`<Var>`](/docs/react/api/components/var) component,
...
<Callout type="warn">
  In cases such as these, you should be using a [`<Branch>`](/docs/react/api/components/branch) or [`<Plural>`](/docs/react/api/components/plural) component instead.

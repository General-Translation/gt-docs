...
Then, you can rename the translation files to the corresponding locale and use [local translations](/docs/next/tutorials/local-tx) to serve the translations to your users.

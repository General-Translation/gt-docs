...
<Callout type="info">
    **Note:**
    ...
    This command executes locally! It does not communicate with GT servers, nor does it require any credentials.
</Callout>
...
See the [scan](/docs/next-cli/scan) command for more details.
...
See the [reference](/docs/next-cli/reference/wrapping) for more details on how the `<T>` component is wrapped.
